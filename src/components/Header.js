                ...
                >
                    {getdata.length ? (
                                        ...
                                        <tr key={index}>
                                            <td>
                                                <NavLink to={`/cart/${e.id}`} onClick={handleClose}>
                                                    <img src={e.imgdata} style={{ width: "5rem", height: "5rem" }} alt={e.rname} />
                                                </NavLink>
                                            </td>
                                            <td>
                                                <p>{e.rname}</p>
                        ...
                        <div className='card_details d-flex justify-content-center align-items-center' style={{ width: "24rem", padding: 10, position: "relative" }}>
                            ...
                            <img src={pic} alt="Empty cart" className='emptycart_img' style={{ width: "5rem", padding: 10 }} />
                        </div>
                    )}
                </Menu>
            </Navbar>
